...
namespace MeshTools{
	void SimplifyMesh(const VertexPosTexNorm *pIndexedVertexData,
		size_t numVertices,
		const uint32_t *pIndexData,
		size_t numIndices,
		std::vector<uint32_t> *pLodData);
	void GenerateAABBData(const VertexPosTexNorm *pIndexedVertexData,
